  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 left-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 transition-colors"
      ...
      {open && (
        <div className="fixed bottom-20 left-5 z-50 w-80">
